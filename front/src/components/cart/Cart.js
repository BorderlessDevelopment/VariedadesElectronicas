                                    ...
                                    <div className="cart-item" key={item.nombre}>
                                        <div className="row">
                                            ...
                                            <div className="col-4 col-lg-3 mt-4 mt-lg-0">
                                                ...
                                                <span className="btn btn-light" onClick={() => decreaseQty(item.product, item.quantity)}>-</span>

                                                <input type="number" className="form-control count d-inline" value={item.quantity} readOnly />

                                                <span className="btn btn-light" onClick={()=>increaseQty(item.product, item.quantity, item.inventario)}>+</span>
                                                </div>
                                            </div>
