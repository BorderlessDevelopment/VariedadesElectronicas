                ...
                <Fragment>
                    ...
                    <div className="row d-flex justify-content-around">
                        ...
                        <div className="col-12 col-lg-5 mt-5">
                            ...
                            <button type="button" id="carrito_btn" className="btn btn-link" disabled={product.inventario === 0}>Agregar al Carrito</button>
                            <hr />
                            ...
                            <button id="btn_review" type="button" className="btn btn-info"
                                data-toggle="modal" data-target="#ratingModal">Deja tu Opinion</button>
                            <div className="alert alert-danger mt-2" type="alert">Inicia Sesión para dejar tu Opinión!</div>
