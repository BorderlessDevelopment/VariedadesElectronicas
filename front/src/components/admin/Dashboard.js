        ...
        <Fragment>
            <div className="row">
                ...
                <div className="col-12 col-md-10">
                    <h2 className="my-6">Tablero de Información</h2>
                        ...
                        <div className="row pr-4">
                            <div className="col-xl-3 col-sm-6 mb-3">
                                <div className="card border-success mb-2 o-hidden h-100">
                                    ...
                                    <Link className="card-footer text-black clearfix small z-1" to="/ProductList">
                            ...
                            <div className="col-xl-3 col-sm-6 mb-3">
                                <div className="card border-warning mb-2 o-hidden h-100">
                                    ...
                                    <Link className="card-footer text-black clearfix small z-1" to="/orderList">
                                        <span className="float-left">Ver Detalles</span>
                                        <span className="float-right">
                                            <i className="fa fa-angle-right"></i>
                                        </span>
